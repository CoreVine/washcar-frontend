  ...
  return (
    <div className='max-w-6xl mx-auto space-y-2 px-4'>
      ...
      <section className='flex flex-wrap xl:gap-14 gap-4 justify-center'>
        <Link href={routes.services("car-wash")} className='space-y-2 text-center'>
        ...
        <Link href={routes.services("rent-car")} className='space-y-2 text-center'>
          <div className='bg-main-gray p-4 rounded-xl flex justify-center items-center size-20'>
        ...
        <Link href={routes.services("buy-car")} className='space-y-2 text-center'>
          <div className='bg-main-gray p-4 rounded-xl flex justify-center items-center size-20'>
